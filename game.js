...
const MILESTONES = [10,20,30,40,50,60,70,79]; // 日记解锁关卡
...
const MEMENTO_LEVELS = [0, 5, 8, 15, 18, 25, 28, 35, 38, 45, 48, 55, 58, 65, 68, 75];
...
这是他们第一次一起去故宫玩，一起站在中轴线，一起共享整个世界的纪念。那天的远哥笑得很美，小派永远忘不了。`},
  8:{name:`蝴蝶结卫衣`, location:`床上的`, story:`这是件特别有纪念意义的衣服。男团期间，正常来说小远的衣服不喜欢被乱弄，在小派的不屈不挠及小远的放任下，小派在彩排时在卫衣的领口处绑了一个非常适合小远的蝴蝶结，甚至在活动结束后也不允许小远拆掉。
这次小远来找他时，把这件衣服留在家里了，小派想小远的时候会偷穿，但更多的时候他把它摆在枕头的另一边，就像他的远哥一直陪在他身边一样。`},
  15:{name:`宜家粉绿色情侣对杯`, location:`厨房台面的`, story:`厨房的杯架放着两只粉色、绿色马克杯。粉色马克杯，是为了特别的人准备的，而另一只「最好看的绿色马克杯」通常都在小派手上或书桌上，装着好喝的咖啡。`},
  18:{name:`绿色围巾`, location:`立式衣架上的`, story:`派派暗搓搓晒着爱意，本来说最爱黑白色性冷淡风的他不知道从何时开始喜欢了绿色，甚至变成他口中「最伟大的颜色」。`},
  25:{name:`狗狗玩偶`, location:`床头的`, story:`一大早小派按下最后一个闹钟，锤打了床头玩偶七下。但每打一下就在心里念一句，哥哥我爱你。`},
  28:{name:`玻璃罩蝴蝶`, location:`客厅书柜上的`, story:`一个周末，派预定了一家手工店，出门做手工，历经九九八十一难，终于做出【玻璃罩蝴蝶】，骄傲拍图并连发18条朋友圈。粉丝问他为什么喜欢蝴蝶，他说：「我喜欢🦋的原因，就是蝴蝶很自由……我觉得它非常的浪漫🌹」
但其实是因为小远的明星符号就是蓝色蝴蝶，可惜不能说。`},
  35:{name:`锁头项链、钥匙项链`, location:`情侣配饰`, story:`自从异地恋生活，小派每次看到小远跟新人的合照都会小小的醋涨了一下。小远知道后，给两人买了情侣配饰【锁、钥匙】，即使小远认识很多新人，小远爱情的锁只有派派可以开。`},
  38:{name:`黑框眼镜`, location:`客厅桌上的两副`, story:`小远有高度近视，但是不爱带框架眼镜，他总感觉他戴上眼镜看起来很呆，但隐形又很伤眼，有时休息不好连轴转，一戴上隐形头就晕的不得了。
...
隔天他们一起去配了两副一样的黑框眼镜，一起带就不呆了。`},
  45:{name:`辣子鸡`, location:`餐桌上的（只有小远小派一起在厨房的画面才出现）`, story:`晚上放学回到家，小远竟然在家，两个人亲密了一番后小派就被远叫去写作业了。小派吭哧吭哧写完作业，发现远做了小派最爱吃的辣子鸡。
男团刚成立的时候，小派刚从泰国来到中国，对中国料理说不上多热爱，直到小远深夜做了【辣子鸡】给他吃，从此这就是他最爱的料理了。他永远都会记得那个夜晚，整个团小远只叫他一个人来吃，他第一次感受到小远的温柔与关爱，他是他最特别的小孩。`},
  48:{name:`冰箱贴`, location:`冰箱上的`, story:`「派，
我给你放了你爱吃的菜，记得吃。
你下次想吃什么再跟我说。」
...
演出结束后，小远把这顶帽子寄给了小派，弥补小派参与不了小远个人巡演的遗憾。`},
  58:{name:`环球影城合照`, location:`二楼窗台矮柜上的`, story:`小派盯着天气预报找到了一个凉快的晴天，预订了两张环球影城门票，又网购了两套巫师袍。
...
近些，再靠近些。勇敢的求爱者会遇到一双结结实实捧住他炽热心脏的手。`},
  65:{name:`小王子氛围灯`, location:`二楼窗台矮柜上的`, story:`小派跟小远说过小王子的故事，小王子守着他的玫瑰在小小的星球上，他们拥有彼此而不再孤单。看到这个礼物，小派哈特软软，气消了大半，别扭地发消息问伯远是不是你买的……
｛聊天内容｝`},
  68:{name:`专辑《月亮》`, location:`客厅桌上的`, story:`因为小远在歌手的路上越走越远，小派除了演员外对于音乐制作也有天赋，俩人在音乐上有了更多合作。派派写曲子、英文歌词，小远再帮小派填成中文、帮录和声。
...
「如果远哥来的时候能睡在一起就好了……」小派想到这,傻笑了起来。`},
  10:{title:`恋爱日记 · 第一篇`, text:`小远是歌手,常在各地飞来飞去开演唱会,不能常来找他。虽然房子布置的很舒服,但小派总觉得房子还是空空的。
...
情侣杯、情侣饰品,这些在团里不能展现的爱意,充斥了两个人的家。`},
  20:{title:`恋爱日记 · 第二篇`, text:`小派读书很用功,考上电影学院后专业技能提升很快,不多时日便接到了电影的重要男配。煲电话粥的时间小远也会陪他一起对词,但更多时候只是开着扩音各自忙着自己的工作。
...
两个人都在为了同一个梦想各自努力着。在外面小远是明星歌手,小派是大学生演员,但在家里,他们只是彼此爱的那个人。`},
  30:{title:`恋爱日记 · 第三篇`, text:`小派最近有点不高兴,因为小远的工作有点太忙了,而且小远在工作中好像遇见了…嗯…很多新的人。
异地恋,小派吃醋,小派心慌。
...
三秒钟和一秒钟不一样,小派有讲究的。`},
  40:{title:`恋爱日记 · 第四篇`, text:`身为歌手的小远在各地飞,偶尔来北京也是两三天就赶着要去下一个地方。小派特别珍惜这两三天,总是尽可能地跟小远待在一起。
...
但我舍不得,舍不得你在舞台上发光的样子,舍不得你的歌声跟笑容。`},
  50:{title:`恋爱日记 · 第五篇`, text:`随着小远越来越红,小派即将毕业,两人的生活越发繁忙起来。
...
但这世上哪里会有天造地设的一对,有时候爱足够,但缘分到头,也是枉然。`},
  60:{title:`恋爱日记 · 第六篇`, text:`秋天来了,冷空气来了,云层一天比一天厚,直到再也兜不住雨,发泄似地下了一天一夜。在小派做完毕业小组作业的那天晚上,接到了小远打来的电话。
...
小派隔天在朋友圈发了一段话:
"morning sunshine☀️"​`},
  70:{title:`恋爱日记 · 第七篇`, text:`那天之后,伯远把工作重心迁来北京,他签了北京的经纪公司,拎着一行李箱脏衣服强势入驻尹派小家。
